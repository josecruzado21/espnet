...
train_asr_mms_aleb_dro_0.0001_la_0.1:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(MMS_LOSS_CTC_0.0001_LA_0.1_ALEB_ARGS) $(BASE_PARAMS)

train_asr_xlsr_aleb_dro_0.0001_la_0.1:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(XLSR_LOSS_CTC_0.0001_LA_0.1_ALEB_ARGS) $(BASE_PARAMS)

train_asr_mms_aleb_dro_0.0001_la_0.5:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(MMS_LOSS_CTC_0.0001_LA_0.5_ALEB_ARGS) $(BASE_PARAMS)

train_asr_xlsr_aleb_dro_0.0001_la_0.5:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(XLSR_LOSS_CTC_0.0001_LA_0.5_ALEB_ARGS) $(BASE_PARAMS)
...
train_asr_xlsr_aleb_dro_0.0001_la_1.0:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(XLSR_LOSS_CTC_0.0001_LA_1.0_ALEB_ARGS) $(BASE_PARAMS)

train_asr_mms_aleb_dro_0.001_la_0.1:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(MMS_LOSS_CTC_0.001_LA_0.1_ALEB_ARGS) $(BASE_PARAMS)

train_asr_xlsr_aleb_dro_0.001_la_0.1:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(XLSR_LOSS_CTC_0.001_LA_0.1_ALEB_ARGS) $(BASE_PARAMS)

train_asr_mms_aleb_dro_0.001_la_0.5:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(MMS_LOSS_CTC_0.001_LA_0.5_ALEB_ARGS) $(BASE_PARAMS)

train_asr_xlsr_aleb_dro_0.001_la_0.5:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(XLSR_LOSS_CTC_0.001_LA_0.5_ALEB_ARGS) $(BASE_PARAMS)

train_asr_mms_aleb_dro_0.001_la_1.0:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(MMS_LOSS_CTC_0.001_LA_1.0_ALEB_ARGS) $(BASE_PARAMS)

train_asr_xlsr_aleb_dro_0.001_la_1.0:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(XLSR_LOSS_CTC_0.001_LA_1.0_ALEB_ARGS) $(BASE_PARAMS)
