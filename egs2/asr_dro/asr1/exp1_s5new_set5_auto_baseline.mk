...
MMS_LOSS_CTC_0.001_ARGS= --asr_config conf/$(EXPERIMENT_ID)/mms_example_baseline_0.001.yaml

train_mms_ctc_aleb_0.001:
	./run_multi.sh $(COMMON_TRAIN_ARGS) $(MMS_LOSS_CTC_0.001_ARGS) $(ALEB_PARAMS)

eval_dev_mms_ctc_aleb_0.001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD_DEV)

eval_test_mms_ctc_aleb_0.001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD_TEST)
